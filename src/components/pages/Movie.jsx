...
//   useEffect(() => {
//     fetch(
//       "https://api.themoviedb.org/3/movie/popular?api_key=0466376d0c5ab578b755f58c7beec394&language=en-US&page=15"
//     )
//       .then((response) => response.json())
//       // .then((result) => console.log(result.results))
//       .then((result) => setpPopular(result.results))
//       .catch((error) => console.log(error));
//   }, []);
...
//         <MoviePopular moviepopular={popular} />
